...
namespace BEOfficialFileImport
{
    ...
    public class CPCOfficialFileConfigCollection : List<CPCOfficialFileConfig>
    {
        public CPCOfficialFileConfigCollection()
        {
            ...
            Add(new CPCOfficialFileConfig("200007", "视为放弃取得专利申请权或专利权的权利通知书", "memo"));
            ...
            Add(new CPCOfficialFileConfig("200031", "补缴费用通知书", "supplementary payment"));
            ...
            Add(new CPCOfficialFileConfig("200303", "视为未委托专利代理机构通知书", "memo", "DXD"));
            ...
            Add(new CPCOfficialFileConfig("200903", "恢复权利请求补正通知书", "memo"));
            ...
            Add(new CPCOfficialFileConfig("230201", "补正通知书", "oa corr", DeadlineFiledType.Deadline, "deemwithdraw", "生物材料", 15, 2, "DXD"));
            Add(new CPCOfficialFileConfig("230301", "第N次补正通知书", "oa corr", DeadlineFiledType.OA, "correction", "", 15, 2, "XN"));
            Add(new CPCOfficialFileConfig("230302", "审查意见通知书", "oa", "XN"));
